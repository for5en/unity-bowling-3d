...
public class GameManager : MonoBehaviour
{
    ...
    public AudioClip loser, spare, strike;
    public float loudMusic = 1f;
    public float quietMusic = 0.5f;
    ...
    void Update()
    {
        if(!audioSource.isPlaying)
        {
            ...
            audioSource.Play();
            musicNum = (musicNum+1) % music.Length;
        }
        ...
        {
            if(playerNames.Count != 0 && inputPlayer.text == "")
            {
                StartGame();
            }
            else
        ...
        switch (phase)
        {
            ...
            case GamePhase.Grade:
                ...
                if (grade == 10 && !secondThrow) 
                {
                    audioSource.PlayOneShot(strike, 2f);
                    gradeText.text = "STRIKE!";
                }
                else if (grade + prev == 10) 
                {
                    audioSource.PlayOneShot(spare, 2f);
                    gradeText.text = "SPARE";
                }
                else if (grade == 0) 
                {
                    audioSource.PlayOneShot(loser, 2f);
                    gradeText.text = "LOSER";
                }
